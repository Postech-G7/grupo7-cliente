...
import { PedidoUseCases } from "../../../../core/applications/usecases/pedido.usecases";
import { PedidoDatabase } from "../../../driven/infra/database/pedido.database";
import { ClienteUseCases } from "../../../../../cliente/core/applications/usecases/cliente.usecases";
import { ClienteDatabase } from "../../../../../cliente/adapter/driven/infra/database/cliente.database";
import { ProdutoDatabase } from "../../../driven/infra/database/produto.database";
import { ProdutoUseCases } from "../../../../core/applications/usecases/produto.usecases";
import { PagamentoUseCases } from "../../../../../pagamento/core/applications/usecases/pagamento.usecases";
import { PagamentoDatabase } from "../../../../../pagamento/adapter/driven/infra/database/pagamento.database";
import { PagamentoExternal } from "../../../../../pagamento/adapter/driven/infra/external/pagamento.external";
import { Identity } from "../../../../../cliente/adapter/driven/infra/identity/identity";
  ...
  (request: Request, _response: Response, next: NextFunction) => {
    ...
    */
    ...
    const service = new PedidoUseCases(
      ...
      new PagamentoUseCases(new PagamentoDatabase(), new PagamentoExternal())
    );
