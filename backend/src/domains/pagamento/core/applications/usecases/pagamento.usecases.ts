...
import { PagamentoDatabase } from "../../../adapter/driven/infra/database/pagamento.database";
...
import { PagamentoExternal } from "../../../adapter/driven/infra/external/pagamento.external";
import { StatusPagamentoMercadoPago } from "../../../adapter/driven/infra/external/mercadopago/mercadopago";
...
export class PagamentoUseCases {
  ...
  async webhookPagamentos(
    ...
    if (pagamento?.getStatus() !== StatusPagamento.PENDENTE) {
      ...
      return new CustomError(message, 400, false, [message]);
    }
